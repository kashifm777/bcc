...
def main():
    #st.beta_set_page_config(page_title='Breast Cancer Detection', layout='centered', initial_sidebar_state='auto')
    st.set_page_config(layout='wide', page_title='Breast Cancer Detection', page_icon='tumor_icon.png', initial_sidebar_state='auto')
